    ...
    function printIteratorValues(iterator, config3, indentation, depth, refs, printer) {
      ...
      if (!current.done) {
        ...
        while (!current.done) {
          ...
          result += printer(current.value, config3, indentationNext, depth, refs);
          current = iterator.next();
          if (!current.done) {
            result += `,${config3.spacingInner}`;
          } else if (!config3.min) {
...
var require_AsymmetricMatcher = __commonJS({
  "node_modules/pretty-format/build/plugins/AsymmetricMatcher.js"(exports) {
    ...
    var SPACE = " ";
    var serialize2 = (val, config3, indentation, depth, refs, printer) => {
...
var require_DOMCollection = __commonJS({
  "node_modules/pretty-format/build/plugins/DOMCollection.js"(exports) {
    ...
    var serialize2 = (collection, config3, indentation, depth, refs, printer) => {
...
var require_markup = __commonJS({
  "node_modules/pretty-format/build/plugins/lib/markup.js"(exports) {
    ...
    var printChildren = (children, config3, indentation, depth, refs, printer) => children.map(
      (child) => config3.spacingOuter + indentation + (typeof child === "string" ? printText(child, config3) : printer(child, config3, indentation, depth, refs))
    ).join("");
    ...
    var printElement = (type2, printedProps, printedChildren, config3, indentation) => {
      const tagColor = config3.colors.tag;
      return `${tagColor.open}<${type2}${printedProps && tagColor.close + printedProps + config3.spacingOuter + indentation + tagColor.open}${printedChildren ? `>${tagColor.close}${printedChildren}${config3.spacingOuter}${indentation}${tagColor.open}</${type2}` : `${printedProps && !config3.min ? "" : " "}/`}>${tagColor.close}`;
    };
    exports.printElement = printElement;
    var printElementAsLeaf = (type2, config3) => {
      const tagColor = config3.colors.tag;
...
var require_DOMElement = __commonJS({
  "node_modules/pretty-format/build/plugins/DOMElement.js"(exports) {
    ...
    var serialize2 = (node, config3, indentation, depth, refs, printer) => {
      if (nodeIsText(node)) {
      ...
      if (++depth > config3.maxDepth) {
        return (0, _markup.printElementAsLeaf)(type2, config3);
      }
...
var require_Immutable = __commonJS({
  "node_modules/pretty-format/build/plugins/Immutable.js"(exports) {
    ...
    var SPACE = " ";
    var LAZY = "\u2026";
    var printImmutableEntries = (val, config3, indentation, depth, refs, printer, type2) => ++depth > config3.maxDepth ? printAsLeaf(getImmutableName(type2)) : `${getImmutableName(type2) + SPACE}{${(0, _collections.printIteratorEntries)(
      val.entries(),
      config3,
      indentation,
      depth,
    ...
    var printImmutableValues = (val, config3, indentation, depth, refs, printer, type2) => ++depth > config3.maxDepth ? printAsLeaf(getImmutableName(type2)) : `${getImmutableName(type2) + SPACE}[${(0, _collections.printIteratorValues)(
      val.values(),
      config3,
      indentation,
      depth,
...
var require_ReactElement = __commonJS({
  "node_modules/pretty-format/build/plugins/ReactElement.js"(exports) {
    ...
    var serialize2 = (element, config3, indentation, depth, refs, printer) => ++depth > config3.maxDepth ? (0, _markup.printElementAsLeaf)(getType3(element), config3) : (0, _markup.printElement)(
      getType3(element),
      (0, _markup.printProps)(
        getPropKeys(element),
        element.props,
...
var require_ReactTestComponent = __commonJS({
  "node_modules/pretty-format/build/plugins/ReactTestComponent.js"(exports) {
    ...
    var serialize2 = (object2, config3, indentation, depth, refs, printer) => ++depth > config3.maxDepth ? (0, _markup.printElementAsLeaf)(object2.type, config3) : (0, _markup.printElement)(
      object2.type,
  ...
  "node_modules/chai/lib/chai/utils/inspect.js"(exports, module2) {
    ...
    function inspect3(obj, showHidden, depth, colors) {
      var options = {
        ...
        showHidden,
        truncate: config3.truncateThreshold ? config3.truncateThreshold : Infinity
      };
...
var require_isProxyEnabled = __commonJS({
  "node_modules/chai/lib/chai/utils/isProxyEnabled.js"(exports, module2) {
    ...
    module2.exports = function isProxyEnabled() {
      return config3.useProxy && typeof Proxy !== "undefined" && typeof Reflect !== "undefined";
    };
  }
});
...
var serialize$1 = (val, config3, indentation, depth, refs, printer) => {
  const name = val.getMockName();
  const nameString = name === "vi.fn()" ? "" : ` ${name}`;
  let callsString = "";
  if (val.mock.calls.length !== 0) {
    const indentationNext = indentation + config3.indent;
    callsString = ` {${config3.spacingOuter}${indentationNext}"calls": ${printer(val.mock.calls, config3, indentationNext, depth, refs)}${config3.min ? ", " : ","}${config3.spacingOuter}${indentationNext}"results": ${printer(val.mock.results, config3, indentationNext, depth, refs)}${config3.min ? "" : ","}${config3.spacingOuter}${indentation}}`;
  }
  ...
  const utils = {
    useFakeTimers(config3) {
      ...
      if (workerState.isChildProcess) {
        if (((_a2 = config3 == null ? void 0 : config3.toFake) == null ? void 0 : _a2.includes("nextTick")) || ((_d = (_c = (_b = workerState.config) == null ? void 0 : _b.fakeTimers) == null ? void 0 : _c.toFake) == null ? void 0 : _d.includes("nextTick"))) {
          throw new Error(
      ...
      if (config3)
        _timers.configure({ ...workerState.config.fakeTimers, ...config3 });
      else
...
async function transactionsRoutes(app2) {
  ...
  app2.get(
    ...
    async (request2, reply) => {
      ...
      const { id } = getTransactionSchema.parse(request2.params);
  ...
  app2.post("/", async (request2, reply) => {
    ...
    const { title, amount, type: type2 } = createTransactionBodySchema.parse(
      request2.body
    );
    const transactionTax = type2 === "credit" ? 0.15 : 0;
    const transactionAmount = ["debit", "pix"].includes(type2) ? (amount + transactionTax) * -1 : amount + transactionTax;
...
describe("Transactions Routes", () => {
  ...
  beforeEach(async () => {
    (0, import_child_process.execSync)("npm run knex migrate:rollback --all");
    (0, import_child_process.execSync)("npm run knex migrate:latest");
  });
  it("should be able to can create a new transaction", async () => {
    const response = await (0, import_supertest.default)(app.server).post("/transactions").send({
      title: "New Transaction",
      amount: 100,
      type: "debit"
    });
    globalExpect(response.status).toEqual(201);
  });
  it("should be able to list a transaction", async () => {
    const createTransactionResponse = await (0, import_supertest.default)(app.server).post("/transactions").send({
      title: "New Transaction",
      amount: 100,
      type: "debit",
      tax: 0
    ...
    const listTransactionsResponse = await (0, import_supertest.default)(app.server).get("/transactions").set("Cookie", cookies);
    globalExpect(listTransactionsResponse.body.transactions).toEqual([
  ...
  it("should be able to list all transactions", async () => {
    ...
    const listTransactionResponse = await (0, import_supertest.default)(app.server).get(`/transactions/${transactionId}`).set("Cookie", cookies);
    globalExpect(listTransactionResponse.body.transaction).toEqual(
      globalExpect.objectContaining({
        title: "New Transaction",
        amount: -100,
        type: "debit",
  ...
  it.only("should be able to list the transactions summary", async () => {
    ...
    const cookies = createTransactionResponse.get("Set-Cookie");
    await (0, import_supertest.default)(app.server).post("/transactions").set("Cookie", cookies).send({
      title: "New Credit Transaction",
      amount: 10,
      type: "credit",
      tax: 0
    });
    const listSummaryResponse = await (0, import_supertest.default)(app.server).get("/transactions/summary").set("Cookie", cookies);
    globalExpect(listSummaryResponse.body.summary).toEqual({
      amount: 20.3
    });
  });
});
